...
int main(int argc, char *argv[])
{
  ...
  while((len = kseq_read(kseq1)) > 0)
  {
    ...
    fprintf(IFQ, "@%.*s%s\n%.*s\n+\n%.*s\n", (int) kseq1->name.l, kseq1->name.s, (is_same ? p1 : empty), (int) kseq1->seq.l, kseq1->seq.s, (int) kseq1->qual.l, kseq1->qual.s);
    fprintf(IFQ, "@%.*s%s\n%.*s\n+\n%.*s\n", (int) kseq2->name.l, kseq2->name.s, (is_same ? p2 : empty), (int) kseq2->seq.l, kseq2->seq.s, (int) kseq2->qual.l, kseq2->qual.s);
  }
