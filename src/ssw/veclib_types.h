...
typedef VECLIB_ALIGNED16 vector float __m128;

#ifdef VECLIB_VSX
typedef VECLIB_ALIGNED16 vector double __m128d;
#endif

typedef VECLIB_ALIGNED16 vector unsigned char __m128i;

typedef VECLIB_ALIGNED16 struct {
  __m128i m128i_0;
  __m128i m128i_1;
} __m256i;
...
typedef VECLIB_ALIGNED16 union {
  __m128i as_m128i;
  __m64 as_m64[2];
