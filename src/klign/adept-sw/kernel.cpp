...
gpu_bsw::warpReduceMax_with_index(short val, short& myIndex, short& myIndex2, unsigned lengthSeqB, bool reverse){
    int   warpSize = 32;
    short myMax    = 0;
    short newInd   = 0;
    short newInd2  = 0;
...
__device__ short gpu_bsw::blockShuffleReduce_with_index(short myVal, short& myIndex, short& myIndex2, unsigned lengthSeqB, bool reverse)
{
...
__global__ void gpu_bsw::dna_kernel(char* seqA_array, char* seqB_array, unsigned* prefix_lengthA,
...
__global__ void gpu_bsw::aa_kernel(char* seqA_array, char* seqB_array, unsigned* prefix_lengthA,unsigned* prefix_lengthB, short* seqA_align_begin, short* seqA_align_end, short* seqB_align_begin, short* seqB_align_end, short* top_scores, short startGap, short extendGap, short* scoring_matrix, short* encoding_matrix, bool reverse)
{
  int block_Id  = blockIdx.x;
  int thread_Id = threadIdx.x;
  short laneId = threadIdx.x%32;
