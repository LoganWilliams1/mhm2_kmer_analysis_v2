...
Perform alignment of reads to final assembly after assembly has completed. If set to true. MHM2 will align the original reads to the final assembly and report the results in a file, `final_assembly.sam`, in [SAM format](https://samtools.github.io/hts-specs/SAMv1.pdf). This defaults to false.
